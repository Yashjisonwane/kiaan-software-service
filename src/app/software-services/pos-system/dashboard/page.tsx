        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <motion.div 
              ...
              className="lg:col-span-2 bg-white/5 border border-white/5 rounded-3xl p-8 min-h-[400px] flex flex-col"
            >
            ...
            <motion.div 
              ...
              className="bg-white/5 border border-white/5 rounded-3xl p-8 flex flex-col"
            >
