...
import { POSCreateAccountModal } from './POSCreateAccountModal';

export interface POSPricingPlan {
  title: string;
  price: string;
  features: string[];
  buttonText: string;
...
const defaultPlans: POSPricingPlan[] = [
  {
...
export const POSPricingSection: React.FC<{ plans?: POSPricingPlan[], subtitle?: string }> = ({ 
  plans = defaultPlans, 
