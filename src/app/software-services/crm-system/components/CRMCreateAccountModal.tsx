...
export const CRMCreateAccountModal: React.FC<Props> = ({ isOpen, onClose, selectedPlan, availablePlans = [] }) => {
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  <label className="block text-xs font-bold text-zinc-300 mb-1 uppercase tracking-wider">Select Service</label>
                    ...
                    <option className="bg-[#0a0a0a] text-white" value="Kiaan Sales Pipeline">Kiaan Sales Pipeline</option>
                    <option className="bg-[#0a0a0a] text-white" value="Kiaan Customer Support">Kiaan Customer Support</option>
                    <option className="bg-[#0a0a0a] text-white" value="Kiaan Marketing Automation">Kiaan Marketing Automation</option>
                    <option className="bg-[#0a0a0a] text-white" value="Kiaan Analytics">Kiaan Analytics</option>
                  </select>
                </div>
