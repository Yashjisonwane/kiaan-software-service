...
import { HRMCreateAccountModal } from './HRMCreateAccountModal';

export interface HRMPricingPlan {
  title: string;
  price: string;
  features: string[];
  buttonText: string;
...
const defaultPlans: HRMPricingPlan[] = [
  {
...
export const HRMPricingSection: React.FC<{ plans?: HRMPricingPlan[], subtitle?: string }> = ({ 
  plans = defaultPlans, 
