...
export default function SoftwareDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] flex overflow-hidden font-sans">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-10 bg-[#F8FAFC]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <motion.div 
              ...
              className="lg:col-span-2 bg-white border border-[#E5E7EB] rounded-3xl p-8 min-h-[400px] flex flex-col shadow-sm"
            >
            ...
            <motion.div 
              ...
              className="bg-white border border-[#E5E7EB] rounded-3xl p-8 flex flex-col shadow-sm"
            >
