...
import { KiaanDentalCoreWorkflow } from './KiaanDentalCoreWorkflow';
import { KiaanDentalCoreFeatures } from './KiaanDentalCoreFeatures';
import { KiaanDentalCoreGallery } from './KiaanDentalCoreGallery';
import { KiaanDentalCorePricing } from './KiaanDentalCorePricing';
import { KiaanDentalCoreForms } from './KiaanDentalCoreForms';
...
export const KiaanDentalCoreLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanDentalCoreFeatures />
      <KiaanDentalCoreWorkflow />
      <KiaanDentalCoreGallery />
      ...
      <KiaanDentalCorePricing />
      <div id="demo">
        <KiaanDentalCoreForms />
      </div>
