...
import './KiaanPharmacyManagement.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 5 - Owns Only KiaanPharmacyManagement component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanPharmacyManagement: React.FC = () => {
  return (
...
export default KiaanPharmacyManagement;