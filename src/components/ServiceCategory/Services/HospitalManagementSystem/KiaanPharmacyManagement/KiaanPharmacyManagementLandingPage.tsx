...
import { KiaanPharmacyManagementWorkflow } from './KiaanPharmacyManagementWorkflow';
import { KiaanPharmacyManagementFeatures } from './KiaanPharmacyManagementFeatures';
import { KiaanPharmacyManagementGallery } from './KiaanPharmacyManagementGallery';
import { KiaanPharmacyManagementPricing } from './KiaanPharmacyManagementPricing';
import { KiaanPharmacyManagementForms } from './KiaanPharmacyManagementForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanPharmacyManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanPharmacyManagementFeatures />
      <KiaanPharmacyManagementWorkflow />
      <KiaanPharmacyManagementGallery />
      ...
      <KiaanPharmacyManagementPricing />
      <div id="demo">
        <KiaanPharmacyManagementForms />
      </div>
