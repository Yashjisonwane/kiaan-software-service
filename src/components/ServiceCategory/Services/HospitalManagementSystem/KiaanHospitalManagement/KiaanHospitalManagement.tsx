...
import './KiaanHospitalManagement.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 5 - Owns Only KiaanHospitalManagement component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanHospitalManagement: React.FC = () => {
  return (
...
export default KiaanHospitalManagement;