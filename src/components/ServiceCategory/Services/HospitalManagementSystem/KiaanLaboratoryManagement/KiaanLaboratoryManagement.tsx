...
import './KiaanLaboratoryManagement.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 5 - Owns Only KiaanLaboratoryManagement component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanLaboratoryManagement: React.FC = () => {
  return (
...
export default KiaanLaboratoryManagement;