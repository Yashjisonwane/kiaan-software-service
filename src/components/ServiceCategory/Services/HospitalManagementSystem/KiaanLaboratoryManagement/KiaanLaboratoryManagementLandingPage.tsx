...
import { KiaanLaboratoryManagementWorkflow } from './KiaanLaboratoryManagementWorkflow';
import { KiaanLaboratoryManagementFeatures } from './KiaanLaboratoryManagementFeatures';
import { KiaanLaboratoryManagementGallery } from './KiaanLaboratoryManagementGallery';
import { KiaanLaboratoryManagementPricing } from './KiaanLaboratoryManagementPricing';
import { KiaanLaboratoryManagementForms } from './KiaanLaboratoryManagementForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanLaboratoryManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanLaboratoryManagementFeatures />
      <KiaanLaboratoryManagementWorkflow />
      <KiaanLaboratoryManagementGallery />
      ...
      <KiaanLaboratoryManagementPricing />
      <div id="demo">
        <KiaanLaboratoryManagementForms />
      </div>
