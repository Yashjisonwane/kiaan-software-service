...
import { KiaanPayrollManagementWorkflow } from './KiaanPayrollManagementWorkflow';
import { KiaanPayrollManagementFeatures } from './KiaanPayrollManagementFeatures';
import { KiaanPayrollManagementGallery } from './KiaanPayrollManagementGallery';
import { KiaanPayrollManagementPricing } from './KiaanPayrollManagementPricing';
import { KiaanPayrollManagementForms } from './KiaanPayrollManagementForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanPayrollManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanPayrollManagementFeatures />
      <KiaanPayrollManagementWorkflow />
      <KiaanPayrollManagementGallery />
      ...
      <KiaanPayrollManagementPricing />
      <div id="demo">
        <KiaanPayrollManagementForms />
      </div>
