...
import { KiaanRecruitmentManagementWorkflow } from './KiaanRecruitmentManagementWorkflow';
import { KiaanRecruitmentManagementFeatures } from './KiaanRecruitmentManagementFeatures';
import { KiaanRecruitmentManagementGallery } from './KiaanRecruitmentManagementGallery';
import { KiaanRecruitmentManagementPricing } from './KiaanRecruitmentManagementPricing';
import { KiaanRecruitmentManagementForms } from './KiaanRecruitmentManagementForms';
    ...
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      <nav className="sticky top-0 w-full z-40 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/5 px-6 py-2.5 flex justify-between items-center">
        <div className="text-sm font-bold uppercase tracking-widest text-white">
          <span className="text-yellow-500">Kiaan</span> HRM System
        </div>
        <div className="flex gap-3">
          <Link href="/products/hrm-system">
      ...
      <section className="pt-28 pb-12 px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold uppercase tracking-tighter mb-6">
            The Ultimate <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-red-600">HRM System</span>
          </h1>
          
          <p className="text-zinc-400 text-base leading-relaxed mb-8 max-w-3xl mx-auto">
            Streamline your operations, boost productivity, and scale your business with our state-of-the-art HRM System. Designed specifically for modern enterprises requiring robust, secure, and intuitive tools.
          </p>
        ...
        <div className="container mx-auto max-w-4xl flex flex-col md:flex-row gap-6 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-zinc-400 text-sm text-zinc-400 leading-relaxed mb-6">
              Our HRM System solves complex operational challenges by centralizing your data into a single, intuitive platform. It is engineered for businesses that demand high performance and seamless integration.
            </p>
      ...
      {/* Modules */}
      <KiaanRecruitmentManagementFeatures />
      <KiaanRecruitmentManagementWorkflow />
      <KiaanRecruitmentManagementGallery />
      ...
      <KiaanRecruitmentManagementPricing />
      <div id="demo">
        <KiaanRecruitmentManagementForms />
      </div>
