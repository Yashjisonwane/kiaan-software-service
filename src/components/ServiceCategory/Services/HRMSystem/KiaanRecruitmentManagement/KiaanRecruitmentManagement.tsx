...
import './KiaanRecruitmentManagement.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 6 - Owns Only KiaanRecruitmentManagement component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanRecruitmentManagement: React.FC = () => {
  return (
...
export default KiaanRecruitmentManagement;