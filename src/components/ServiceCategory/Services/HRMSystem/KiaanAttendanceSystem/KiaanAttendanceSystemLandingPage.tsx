...
import { KiaanAttendanceSystemWorkflow } from './KiaanAttendanceSystemWorkflow';
import { KiaanAttendanceSystemFeatures } from './KiaanAttendanceSystemFeatures';
import { KiaanAttendanceSystemGallery } from './KiaanAttendanceSystemGallery';
import { KiaanAttendanceSystemPricing } from './KiaanAttendanceSystemPricing';
import { KiaanAttendanceSystemForms } from './KiaanAttendanceSystemForms';
...
export const KiaanAttendanceSystemLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanAttendanceSystemFeatures />
      <KiaanAttendanceSystemWorkflow />
      <KiaanAttendanceSystemGallery />
      ...
      <KiaanAttendanceSystemPricing />
      <div id="demo">
        <KiaanAttendanceSystemForms />
      </div>
