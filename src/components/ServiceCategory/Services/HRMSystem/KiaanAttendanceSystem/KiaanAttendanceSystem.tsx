...
import './KiaanAttendanceSystem.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 6 - Owns Only KiaanAttendanceSystem component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanAttendanceSystem: React.FC = () => {
  return (
...
export default KiaanAttendanceSystem;