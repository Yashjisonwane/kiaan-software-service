...
import './KiaanEmployeeManagement.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 6 - Owns Only KiaanEmployeeManagement component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanEmployeeManagement: React.FC = () => {
  return (
...
export default KiaanEmployeeManagement;