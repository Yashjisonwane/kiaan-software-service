...
import { KiaanEmployeeManagementWorkflow } from './KiaanEmployeeManagementWorkflow';
import { KiaanEmployeeManagementFeatures } from './KiaanEmployeeManagementFeatures';
import { KiaanEmployeeManagementGallery } from './KiaanEmployeeManagementGallery';
import { KiaanEmployeeManagementPricing } from './KiaanEmployeeManagementPricing';
import { KiaanEmployeeManagementForms } from './KiaanEmployeeManagementForms';
...
export const KiaanEmployeeManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanEmployeeManagementFeatures />
      <KiaanEmployeeManagementWorkflow />
      <KiaanEmployeeManagementGallery />
      ...
      <KiaanEmployeeManagementPricing />
      <div id="demo">
        <KiaanEmployeeManagementForms />
      </div>
