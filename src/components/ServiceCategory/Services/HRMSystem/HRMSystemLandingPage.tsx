...
import { HRMSystemWorkflow } from './HRMSystemWorkflow';
import { HRMSystemFeatures } from './HRMSystemFeatures';
import { HRMSystemGallery } from './HRMSystemGallery';
import { HRMSystemPricing } from './HRMSystemPricing';
import { HRMSystemForms } from './HRMSystemForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const HRMSystemLandingPage: React.FC = () => {
  return (
