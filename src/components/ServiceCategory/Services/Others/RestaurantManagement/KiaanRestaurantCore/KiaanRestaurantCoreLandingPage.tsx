...
import { KiaanRestaurantCoreWorkflow } from './KiaanRestaurantCoreWorkflow';
import { KiaanRestaurantCoreFeatures } from './KiaanRestaurantCoreFeatures';
import { KiaanRestaurantCoreGallery } from './KiaanRestaurantCoreGallery';
import { KiaanRestaurantCorePricing } from './KiaanRestaurantCorePricing';
import { KiaanRestaurantCoreForms } from './KiaanRestaurantCoreForms';
...
export const KiaanRestaurantCoreLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanRestaurantCoreFeatures />
      <KiaanRestaurantCoreWorkflow />
      <KiaanRestaurantCoreGallery />
      ...
      <KiaanRestaurantCorePricing />
      <div id="demo">
        <KiaanRestaurantCoreForms />
      </div>
