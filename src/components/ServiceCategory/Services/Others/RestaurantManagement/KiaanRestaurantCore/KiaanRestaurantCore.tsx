...
import './KiaanRestaurantCore.css';
import { ServiceCard } from '../../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 4 - Owns Only KiaanRestaurantCore component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanRestaurantCore: React.FC = () => {
  return (
...
export default KiaanRestaurantCore;