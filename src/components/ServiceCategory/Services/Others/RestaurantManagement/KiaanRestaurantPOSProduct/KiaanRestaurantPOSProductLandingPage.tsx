...
import { KiaanRestaurantPOSProductWorkflow } from './KiaanRestaurantPOSProductWorkflow';
import { KiaanRestaurantPOSProductFeatures } from './KiaanRestaurantPOSProductFeatures';
import { KiaanRestaurantPOSProductGallery } from './KiaanRestaurantPOSProductGallery';
import { KiaanRestaurantPOSProductPricing } from './KiaanRestaurantPOSProductPricing';
import { KiaanRestaurantPOSProductForms } from './KiaanRestaurantPOSProductForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanRestaurantPOSProductLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanRestaurantPOSProductFeatures />
      <KiaanRestaurantPOSProductWorkflow />
      <KiaanRestaurantPOSProductGallery />
      ...
      <KiaanRestaurantPOSProductPricing />
      <div id="demo">
        <KiaanRestaurantPOSProductForms />
      </div>
