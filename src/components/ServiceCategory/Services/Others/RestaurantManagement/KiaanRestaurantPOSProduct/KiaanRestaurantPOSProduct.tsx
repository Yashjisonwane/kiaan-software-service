...
import './KiaanRestaurantPOSProduct.css';
import { ServiceCard } from '../../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 4 - Owns Only KiaanRestaurantPOSProduct component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanRestaurantPOSProduct: React.FC = () => {
  return (
...
export default KiaanRestaurantPOSProduct;