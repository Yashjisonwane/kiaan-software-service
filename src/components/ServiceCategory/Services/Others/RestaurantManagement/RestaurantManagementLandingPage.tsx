...
import { RestaurantManagementWorkflow } from './RestaurantManagementWorkflow';
import { RestaurantManagementFeatures } from './RestaurantManagementFeatures';
import { RestaurantManagementGallery } from './RestaurantManagementGallery';
import { RestaurantManagementPricing } from './RestaurantManagementPricing';
import { RestaurantManagementForms } from './RestaurantManagementForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const RestaurantManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <RestaurantManagementFeatures />
      <RestaurantManagementWorkflow />
      <RestaurantManagementGallery />
      ...
      <RestaurantManagementPricing />
      <div id="demo">
        <RestaurantManagementForms />
      </div>
