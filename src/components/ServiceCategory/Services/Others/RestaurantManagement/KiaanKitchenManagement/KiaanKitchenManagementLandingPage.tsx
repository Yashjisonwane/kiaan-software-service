...
import { KiaanKitchenManagementWorkflow } from './KiaanKitchenManagementWorkflow';
import { KiaanKitchenManagementFeatures } from './KiaanKitchenManagementFeatures';
import { KiaanKitchenManagementGallery } from './KiaanKitchenManagementGallery';
import { KiaanKitchenManagementPricing } from './KiaanKitchenManagementPricing';
import { KiaanKitchenManagementForms } from './KiaanKitchenManagementForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanKitchenManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanKitchenManagementFeatures />
      <KiaanKitchenManagementWorkflow />
      <KiaanKitchenManagementGallery />
      ...
      <KiaanKitchenManagementPricing />
      <div id="demo">
        <KiaanKitchenManagementForms />
      </div>
