...
import './KiaanOnlineOrderingSystem.css';
import { ServiceCard } from '../../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 4 - Owns Only KiaanOnlineOrderingSystem component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanOnlineOrderingSystem: React.FC = () => {
  return (
...
export default KiaanOnlineOrderingSystem;