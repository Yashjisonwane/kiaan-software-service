...
import { KiaanAssetTrackingSystemWorkflow } from './KiaanAssetTrackingSystemWorkflow';
import { KiaanAssetTrackingSystemFeatures } from './KiaanAssetTrackingSystemFeatures';
import { KiaanAssetTrackingSystemGallery } from './KiaanAssetTrackingSystemGallery';
import { KiaanAssetTrackingSystemPricing } from './KiaanAssetTrackingSystemPricing';
import { KiaanAssetTrackingSystemForms } from './KiaanAssetTrackingSystemForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanAssetTrackingSystemLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanAssetTrackingSystemFeatures />
      <KiaanAssetTrackingSystemWorkflow />
      <KiaanAssetTrackingSystemGallery />
      ...
      <KiaanAssetTrackingSystemPricing />
      <div id="demo">
        <KiaanAssetTrackingSystemForms />
      </div>
