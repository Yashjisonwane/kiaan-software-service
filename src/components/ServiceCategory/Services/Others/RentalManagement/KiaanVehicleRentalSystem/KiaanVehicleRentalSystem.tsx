...
import './KiaanVehicleRentalSystem.css';
import { ServiceCard } from '../../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 4 - Owns Only KiaanVehicleRentalSystem component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanVehicleRentalSystem: React.FC = () => {
  return (
...
export default KiaanVehicleRentalSystem;