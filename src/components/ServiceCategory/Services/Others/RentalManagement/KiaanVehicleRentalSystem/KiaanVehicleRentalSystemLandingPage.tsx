...
import { KiaanVehicleRentalSystemWorkflow } from './KiaanVehicleRentalSystemWorkflow';
import { KiaanVehicleRentalSystemFeatures } from './KiaanVehicleRentalSystemFeatures';
import { KiaanVehicleRentalSystemGallery } from './KiaanVehicleRentalSystemGallery';
import { KiaanVehicleRentalSystemPricing } from './KiaanVehicleRentalSystemPricing';
import { KiaanVehicleRentalSystemForms } from './KiaanVehicleRentalSystemForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanVehicleRentalSystemLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanVehicleRentalSystemFeatures />
      <KiaanVehicleRentalSystemWorkflow />
      <KiaanVehicleRentalSystemGallery />
      ...
      <KiaanVehicleRentalSystemPricing />
      <div id="demo">
        <KiaanVehicleRentalSystemForms />
      </div>
