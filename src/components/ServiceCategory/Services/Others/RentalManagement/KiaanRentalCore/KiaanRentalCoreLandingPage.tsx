...
import { KiaanRentalCoreWorkflow } from './KiaanRentalCoreWorkflow';
import { KiaanRentalCoreFeatures } from './KiaanRentalCoreFeatures';
import { KiaanRentalCoreGallery } from './KiaanRentalCoreGallery';
import { KiaanRentalCorePricing } from './KiaanRentalCorePricing';
import { KiaanRentalCoreForms } from './KiaanRentalCoreForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanRentalCoreLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanRentalCoreFeatures />
      <KiaanRentalCoreWorkflow />
      <KiaanRentalCoreGallery />
      ...
      <KiaanRentalCorePricing />
      <div id="demo">
        <KiaanRentalCoreForms />
      </div>
