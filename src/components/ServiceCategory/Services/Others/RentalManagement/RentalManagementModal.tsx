...
import { RentalManagementLandingPage } from './RentalManagementLandingPage';

interface Props {
  onClose: () => void;
}

export const RentalManagementModal: React.FC<Props> = ({ onClose }) => {
  return (
