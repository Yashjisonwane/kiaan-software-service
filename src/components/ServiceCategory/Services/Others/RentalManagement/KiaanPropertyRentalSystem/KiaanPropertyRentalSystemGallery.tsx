...
const images = [
  { src: '/images/rental_booking.png', label: 'Booking Dashboard' },
  { src: '/images/rental_calendar.png', label: 'Rental Calendar' }
];

export const KiaanPropertyRentalSystemGallery: React.FC = () => {
  return (
