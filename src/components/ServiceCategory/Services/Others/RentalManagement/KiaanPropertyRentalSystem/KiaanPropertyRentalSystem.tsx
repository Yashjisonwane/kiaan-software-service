...
import './KiaanPropertyRentalSystem.css';
import { ServiceCard } from '../../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 4 - Owns Only KiaanPropertyRentalSystem component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanPropertyRentalSystem: React.FC = () => {
  return (
...
export default KiaanPropertyRentalSystem;