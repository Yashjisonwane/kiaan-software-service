...
import { KiaanMultiStorePOSLandingPage } from './KiaanMultiStorePOSLandingPage';

interface Props {
  onClose: () => void;
}

export const KiaanMultiStorePOSModal: React.FC<Props> = ({ onClose }) => {
  return (
