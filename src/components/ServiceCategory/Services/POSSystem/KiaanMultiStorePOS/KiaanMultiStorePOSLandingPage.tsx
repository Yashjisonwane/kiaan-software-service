...
import { KiaanMultiStorePOSWorkflow } from './KiaanMultiStorePOSWorkflow';
import { KiaanMultiStorePOSFeatures } from './KiaanMultiStorePOSFeatures';
import { KiaanMultiStorePOSGallery } from './KiaanMultiStorePOSGallery';
import { KiaanMultiStorePOSPricing } from './KiaanMultiStorePOSPricing';
import { KiaanMultiStorePOSForms } from './KiaanMultiStorePOSForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanMultiStorePOSLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanMultiStorePOSFeatures />
      <KiaanMultiStorePOSWorkflow />
      <KiaanMultiStorePOSGallery />
      ...
      <KiaanMultiStorePOSPricing />
      <div id="demo">
        <KiaanMultiStorePOSForms />
      </div>
