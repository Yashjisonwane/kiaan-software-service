...
import { POSSystemWorkflow } from './POSSystemWorkflow';
import { POSSystemFeatures } from './POSSystemFeatures';
import { POSSystemGallery } from './POSSystemGallery';
import { POSSystemPricing } from './POSSystemPricing';
import { POSSystemForms } from './POSSystemForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const POSSystemLandingPage: React.FC = () => {
  return (
