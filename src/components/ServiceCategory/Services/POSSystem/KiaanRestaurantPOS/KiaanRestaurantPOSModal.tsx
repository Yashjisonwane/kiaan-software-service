...
import { KiaanRestaurantPOSLandingPage } from './KiaanRestaurantPOSLandingPage';

interface Props {
  onClose: () => void;
}

export const KiaanRestaurantPOSModal: React.FC<Props> = ({ onClose }) => {
  return (
