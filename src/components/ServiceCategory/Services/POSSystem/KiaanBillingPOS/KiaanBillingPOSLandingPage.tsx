...
import { KiaanBillingPOSWorkflow } from './KiaanBillingPOSWorkflow';
import { KiaanBillingPOSFeatures } from './KiaanBillingPOSFeatures';
import { KiaanBillingPOSGallery } from './KiaanBillingPOSGallery';
import { KiaanBillingPOSPricing } from './KiaanBillingPOSPricing';
import { KiaanBillingPOSForms } from './KiaanBillingPOSForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanBillingPOSLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanBillingPOSFeatures />
      <KiaanBillingPOSWorkflow />
      <KiaanBillingPOSGallery />
      ...
      <KiaanBillingPOSPricing />
      <div id="demo">
        <KiaanBillingPOSForms />
      </div>
