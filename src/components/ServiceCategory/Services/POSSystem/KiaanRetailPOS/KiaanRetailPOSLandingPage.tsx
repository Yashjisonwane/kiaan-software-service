...
import { KiaanRetailPOSWorkflow } from './KiaanRetailPOSWorkflow';
import { KiaanRetailPOSFeatures } from './KiaanRetailPOSFeatures';
import { KiaanRetailPOSGallery } from './KiaanRetailPOSGallery';
import { KiaanRetailPOSPricing } from './KiaanRetailPOSPricing';
import { KiaanRetailPOSForms } from './KiaanRetailPOSForms';
...
export const KiaanRetailPOSLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanRetailPOSFeatures />
      <KiaanRetailPOSWorkflow />
      <KiaanRetailPOSGallery />
