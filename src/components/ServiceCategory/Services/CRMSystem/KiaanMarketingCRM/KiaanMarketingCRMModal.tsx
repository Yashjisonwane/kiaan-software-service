...
import { KiaanMarketingCRMLandingPage } from './KiaanMarketingCRMLandingPage';

interface Props {
  onClose: () => void;
}

export const KiaanMarketingCRMModal: React.FC<Props> = ({ onClose }) => {
  return (
