...
import { KiaanMarketingCRMWorkflow } from './KiaanMarketingCRMWorkflow';
import { KiaanMarketingCRMFeatures } from './KiaanMarketingCRMFeatures';
import { KiaanMarketingCRMGallery } from './KiaanMarketingCRMGallery';
import { KiaanMarketingCRMPricing } from './KiaanMarketingCRMPricing';
import { KiaanMarketingCRMForms } from './KiaanMarketingCRMForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanMarketingCRMLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanMarketingCRMFeatures />
      <KiaanMarketingCRMWorkflow />
      <KiaanMarketingCRMGallery />
      ...
      <KiaanMarketingCRMPricing />
      <div id="demo">
        <KiaanMarketingCRMForms />
      </div>
