...
import './KiaanLeadManagement.css';
import { ServiceCard } from '../../../../ServiceCard/ServiceCard';

/* 
 * -------------------------------------------------------------
 * Employee 1 - Owns Only KiaanLeadManagement component
 * -------------------------------------------------------------
 * MANDATORY RULES:
...
export const KiaanLeadManagement: React.FC = () => {
  return (
...
export default KiaanLeadManagement;