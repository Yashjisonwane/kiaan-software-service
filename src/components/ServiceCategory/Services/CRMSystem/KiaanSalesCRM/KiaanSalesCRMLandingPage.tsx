...
import { KiaanSalesCRMWorkflow } from './KiaanSalesCRMWorkflow';
import { KiaanSalesCRMFeatures } from './KiaanSalesCRMFeatures';
import { KiaanSalesCRMGallery } from './KiaanSalesCRMGallery';
import { KiaanSalesCRMPricing } from './KiaanSalesCRMPricing';
import { KiaanSalesCRMForms } from './KiaanSalesCRMForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanSalesCRMLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanSalesCRMFeatures />
      <KiaanSalesCRMWorkflow />
      <KiaanSalesCRMGallery />
