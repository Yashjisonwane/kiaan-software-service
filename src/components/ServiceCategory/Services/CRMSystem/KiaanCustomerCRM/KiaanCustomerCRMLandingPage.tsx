...
import { KiaanCustomerCRMWorkflow } from './KiaanCustomerCRMWorkflow';
import { KiaanCustomerCRMFeatures } from './KiaanCustomerCRMFeatures';
import { KiaanCustomerCRMGallery } from './KiaanCustomerCRMGallery';
import { KiaanCustomerCRMPricing } from './KiaanCustomerCRMPricing';
import { KiaanCustomerCRMForms } from './KiaanCustomerCRMForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const KiaanCustomerCRMLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <KiaanCustomerCRMFeatures />
      <KiaanCustomerCRMWorkflow />
      <KiaanCustomerCRMGallery />
      ...
      <KiaanCustomerCRMPricing />
      <div id="demo">
        <KiaanCustomerCRMForms />
      </div>
