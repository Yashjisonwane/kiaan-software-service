...
import { KiaanCustomerCRMLandingPage } from './KiaanCustomerCRMLandingPage';

interface Props {
  onClose: () => void;
}

export const KiaanCustomerCRMModal: React.FC<Props> = ({ onClose }) => {
  return (
