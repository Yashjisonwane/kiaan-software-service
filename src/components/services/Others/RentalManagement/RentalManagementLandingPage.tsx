...
import { RentalManagementWorkflow } from './RentalManagementWorkflow';
import { RentalManagementFeatures } from './RentalManagementFeatures';
import { RentalManagementGallery } from './RentalManagementGallery';
import { RentalManagementPricing } from './RentalManagementPricing';
import { RentalManagementForms } from './RentalManagementForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const RentalManagementLandingPage: React.FC = () => {
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-yellow-500/30">
      ...
      {/* Modules */}
      <RentalManagementFeatures />
      <RentalManagementWorkflow />
      <RentalManagementGallery />
      ...
      <RentalManagementPricing />
      <div id="demo">
        <RentalManagementForms />
      </div>
