...
import { CRMSystemWorkflow } from './CRMSystemWorkflow';
import { CRMSystemFeatures } from './CRMSystemFeatures';
import { CRMSystemGallery } from './CRMSystemGallery';
import { CRMSystemPricing } from './CRMSystemPricing';
import { CRMSystemForms } from './CRMSystemForms';
import { ArrowRight, CheckCircle } from 'lucide-react';

export const CRMSystemLandingPage: React.FC = () => {
  return (
